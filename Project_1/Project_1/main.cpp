...
int main(int argc, char const *argv[]) {
    ...
    do {
        do {
            system("cls");
            printf("\n\n----------------Menu for Stack Table On Sequence Structure----------------\n\n");
            printf("\t\t1.InitStack(STACK *const,int)");
            printf("\t6.pop(STACK *const, int&)\n");
            printf("\t\t2.InitStack(STACK *const,STACK const&)");
            printf("\t7.assign(STACK*const,const STACK&)\n");
            printf("\t\t3.size(const STACK *const p)");
            printf("\t8.print(const STACK *const)\n");
            printf("\t\t4.howMany(const STACK *const)");
            printf("\t9.destroySTACK(STACK *const)\n");
            printf("\t\t5.push(STACK *const, int)");
            printf("\t0.Exix\n\n");
            printf("---------------------------------------------------------------------------\n");
